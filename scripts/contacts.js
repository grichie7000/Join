...
function showContactDetails(userId) {
    try {
		...
		let moreVertContainer = document.querySelector(".more-vert-container"); // Zugriff auf den Container für "more-vert"
        ...
        if (window.innerWidth <= 950) {
			...
			btn-container-mobile.classList.remove('d-flex');
            btnAddContactMobile.style.display = 'none'; // Button ausblenden
			
			// Entferne d-flex und setze d-none
            
			moreVertContainer.classList.remove('d-none');
